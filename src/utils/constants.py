...
def parse_args():
      ...
      parser = argparse.ArgumentParser(description='MSRP-RFPN') #MSRP-RFPN
      ...
      parser.add_argument('--CLASSIFIERS', type=str, default='LKRFN_torch',
...
def create_classifier(classifier_name, nb_classes):
    ...
    if classifier_name == 'LKRFN_torch':
        from src.classifiers import LKRFN_torch
        # __init__(self, in_channels, out1_channels_1, out1_channels_2, out1_channels_3, 
        #          out1_channels_4, out2_channels_1, out2_channels_2, out2_channels_3, 
        #          out2_channels_4, num_class)
        return LKRFN_torch.LKRFN(1, 16, 32, 96, 16, 32, 64, 192, 32, nb_classes), LKRFN_torch
